const auth = 'a82af008-ae22-e711-8708-d89d6763b1d9';
...
const variables = {
  ...
  max: {
    ...
    prot: 110, // maximum of protein for the cal above
...
var optionsJet = { method: 'POST',
  ...
  body: '{"zipcode":"07030","sku":"3626db15485148d2bab3a37628b85a45","origination":"PLP"}' };

request(optionsJet, function (error, response, body) {
...
app.get('/hoboken', function(req, res) {
    Product.find({aisle: {$nin: ['2', '3', '4', '5', '6', '13', '14', '15']}}).select('brand name current_price size sku').populate('nutrition', 'protein calories serving_count').populate('nutritionNDB', 'Protein Energy eq_gram unit_type unit').exec(function(err, prods) {
        ...
        prods = prods.filter(function(prod) { 
            return prod.protein_calorie_ratio >= prot_goal * 4 / cal_goal * 100 &&  // 150/1600 protein:cal ratio
